...
class StoryController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    let stories = [
        ...
        "recent": [
            ...
            [
                Story(username: "Username2", mediaType: MediaType.video, medialink: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4", date: "yesterday", status: Status.read),
                Story(username: "Username2", mediaType: MediaType.video, medialink: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4", date: "yesterday", status: Status.read),
            ],
            [
